...
public class Constants {
    ...
    public static class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "me.biubiubiu.one";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "one";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "me.biubiubiu.one.sync";
    ...
    public static class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "me.biubiubiu.one.";
